...
import 'text_field/custom_calendar_date_picker.dart';
...
class _DatePickerDialogState extends State<DatePickerDialog> with RestorationMixin {
  ...
  Widget build(BuildContext context) {
    ...
    headlineStyle = headlineStyle?.copyWith(color: AppColors.white);
            ...
            switch (orientation) {
              case Orientation.portrait:
                return Column(
                  ...
                  children: <Widget>[
                    header,
                    if (useMaterial3) const Divider(height: 0, color: Color(0xff49454F)),
                    Expanded(child: picker),//TODO
                    actions,
                  ],
                );
              case Orientation.landscape:
...
class _DayHeaders extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final ColorScheme colorScheme = themeData.colorScheme.copyWith(
